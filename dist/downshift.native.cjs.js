...
var _initialiseProps = function () {
  ...
  this.getButtonProps = function () {
    ...
    {
      onPress: composeEventHandlers(onClick, _this5.button_handleClick)
    };
  ...
  this.button_handleClick = function (event) {
    ...
    true && _this5._inputNode) {
      _this5._inputNode.focus();
    }
  ...
  this.getInputProps = function () {
    ...
    return _extends({
      ...
      id: _this5.inputId
    }, _babelHelpers$extends2[refKey] = _this5.inputRef, _babelHelpers$extends2));
  };
  ...
  this.updateStatus = debounce(function () {
    ...
    _this5.props.getA11yStatusMessage(_extends({
